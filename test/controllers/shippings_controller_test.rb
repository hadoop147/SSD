...
class ShippingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipping" do
    assert_difference('Shipping.count') do
      post shippings_url, params: { shipping: { address_id: @shipping.address_id, customer_id: @shipping.customer_id, date_shipped: @shipping.date_shipped, order_id: @shipping.order_id } }
    end
  ...
  test "should update shipping" do
    patch shipping_url(@shipping), params: { shipping: { address_id: @shipping.address_id, customer_id: @shipping.customer_id, date_shipped: @shipping.date_shipped, order_id: @shipping.order_id } }
